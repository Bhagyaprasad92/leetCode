<h2><a href="https://leetcode.com/problems/reverse-string-prefix/?envType=problem-list-v2&envId=two-pointers">3794. Reverse String Prefix</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> and an integer <code>k</code>.</p>
